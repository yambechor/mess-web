    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-8 bg-gradient-to-b from-black via-purple-950/20 to-black">
      <div className="text-center max-w-md">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400 mt-2">Nightlife Events</p>
        </div>

        {/* Description */}
        <p className="text-gray-300 text-lg mb-8">
          Discover the best nightlife events near you. Connect with venues, buy tickets, and never miss a party.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            ...
            className="flex items-center justify-center gap-2 bg-white text-black px-6 py-3 rounded-xl font-semibold hover:bg-gray-100 transition-colors"
          >
